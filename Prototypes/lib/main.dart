...
import 'package:demo_project_2/GeoLocation.dart';
import 'package:demo_project_2/logoutpage.dart';
import 'package:demo_project_2/PostNote.dart';
          ...
          children: <Widget>[
                  ...
                  Container(
                    ...
                    decoration: const BoxDecoration(
                        ...
                        image: DecorationImage(
                            image: NetworkImage(
                                "https://lh3.googleusercontent.com/a-/AOh14GjM0tRTvlXHUPdjZuXQxzENKlxc5JZcq65KgcZSVg=s83"))),
                  ),
                  const Text(
                    "Rao Faraz Shakeel",
                    style: TextStyle(
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.of(context).pop();
                Navigator.push(
                    context, MaterialPageRoute(builder: (context) => PostNote()));
              },
            ),
            ListTile(
              title: const Text(
